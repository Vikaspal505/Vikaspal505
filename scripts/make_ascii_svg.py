...
HANDLE = "vikas"        # shown in the titlebar as HANDLE@github
FULL_NAME = "Vikas Pal" # shown after `whoami` in the status bar
...
parts.append(f'<text x="{PAD}" y="{status_y:.1f}" fill="{TITLE_TEXT}" font-size="13">'
             f'{HANDLE}@github:~$ whoami <tspan fill="{INK}">{FULL_NAME}</tspan></text>')
