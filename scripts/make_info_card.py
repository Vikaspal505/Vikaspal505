...
# ===========================================================================
HOST = "vikas"   # shown as  vikas@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Open Source Contributor"),
    ("kv", "Role", "Backend Engineer"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "HTML, CSS, JavaScript"),   # PLACEHOLDER -- edit to your real tools
    ("kv", "Backend", "Node.js, Python"),          # PLACEHOLDER -- edit to your real tools
    ("kv", "AI / ML", "Python, ML basics"),        # PLACEHOLDER -- edit to your real tools
    ("kv", "Cloud", "AWS, Docker"),                # PLACEHOLDER -- edit to your real tools
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Contributing to open source projects"),   # PLACEHOLDER -- edit to your real highlights
    ("bul", "Building backend systems that just work"), # PLACEHOLDER -- edit to your real highlights
]
